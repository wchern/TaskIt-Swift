...
//  TaskIt
//
//  Created by William Chern on 7/1/2015.
...
class ViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, NSFetchedResultsControllerDelegate, TaskDetailViewControllerDelegate, AddTaskViewControllerDelegate {
    ...
    func showAlert(message:String = "Your task has been updated.") {
        var alert = UIAlertController(title: "Task Details", message: message, preferredStyle: UIAlertControllerStyle.Alert)
